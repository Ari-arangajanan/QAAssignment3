...
public class AddtoWatchlistTestcase extends BaseTest {
    ...
    @Test
    public void addToWishliastCamera() {
        ...
        String screenshotPath3 = ScreenShots.takeScreenshot(driver, "AddToWatchList");
